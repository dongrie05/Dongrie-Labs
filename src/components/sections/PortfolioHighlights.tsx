...
export function PortfolioHighlights() {
  ...
  return (
    <section className="relative py-24 overflow-hidden" ref={scrollRef}>
          ...
          <AnimateOnScroll>
            <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
              <div>
                ...
                <h2 className="font-heading mt-3 text-4xl font-bold tracking-tight text-white md:text-5xl lg:text-6xl">
                  {t('title')}
                </h2>
              ...
              <Link
                href="/portfolio"
                className="group inline-flex shrink-0 items-center gap-2 text-sm font-medium text-slate-400 transition-colors hover:text-white"
              >
                {t('viewFull')}
      ...
      {/* Horizontal scrolling cards driven by vertical scroll */}
      <motion.div
      ...
      >
        {highlightedProjects.map((project, i) => (
          <motion.div
            ...
            className="group w-[340px] shrink-0 sm:w-[400px] lg:w-[440px]"
          >
            <Link href={`/portfolio/${project.slug}`} className="block">
              <div className="relative overflow-hidden rounded-2xl border border-white/[0.06] bg-navy-900/60 transition-all duration-500 hover:border-white/[0.12] hover:-translate-y-2 hover:shadow-2xl hover:shadow-blue-500/[0.06]">
                <div className="relative flex h-56 items-center justify-center overflow-hidden bg-navy-800/40 sm:h-64">
                  ...
                  {/* Hover overlay */}
                  <div className="absolute inset-0 flex items-center justify-center bg-blue-500/10 opacity-0 backdrop-blur-[2px] transition-all duration-500 group-hover:opacity-100">
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.2 }}
          transition={{
            delay: highlightedProjects.length * 0.1,
            duration: 0.6,
            ease: [0.21, 0.47, 0.32, 0.98],
          }}
        ...
        >
          <Link
            href="/portfolio"
            className="flex h-full min-h-[360px] flex-col items-center justify-center rounded-2xl border border-dashed border-white/[0.08] bg-navy-900/30 transition-all duration-500 hover:border-blue-500/30 hover:bg-navy-900/60"
          >
